...
Function Do-S3SignPostingForm {
    ...
    .EXAMPLE
        Do-AWSSignS3PostingForm.ps1 -form .\UploadPolicyDocument | format-list
    ...
    .LINK
        http://sushihangover.blogspot.com/2012/03/powershell-aws-s3-form-signing-base64.html
